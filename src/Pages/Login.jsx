    ...
    <PageTitle title={'Login'}></PageTitle>
     ...
     data-aos-duration="1000">
      ...
      <div className="flex justify-center space-x-4">
        <button  onClick={handlegoogle} aria-label="Log in with Google" className="px-3 border-2 border-solid border-gray-200 cursor-pointer rounded-sm" data-aos="fade-up"
     data-aos-duration="2000">
          ...
          <strong className="text-2xl font-bold">oogle</strong>
        </button>
        
        <button onClick={handlegithub} aria-label="Log in with GitHub" className="px-3  rounded-sm  border-2 border-solid border-gray-200  cursor-pointer" data-aos="fade-up"
     data-aos-duration="2500">
          ...
          >
            ...
            <strong className="text-2xl font-bold"> Github</strong>
        </button>
      </div>
