    ...
    <div>
      ...
      <form onSubmit={handleSaveChanges}>
        <fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-50  bg-[#F2F6F7] py-28 ">
          ...
          <div className="space-y-2 col-span-full flex flex-col items-center justify-center lg:col-span-1">
          ...
          <div
            className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3 px-2"
            data-aos="fade-up"
